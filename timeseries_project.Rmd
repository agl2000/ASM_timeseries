...
# By looking at these plots, we see there might not be a huge difference in variance stabilization
...
monthplot(
  serie,
  main = "Monthplot of the Original Series",
  ylab = "Thousands of Vehicles",
  col = "blue"
)
...
ts.plot(
  matrix(serie, nr = 12),
  main = "Time Series Matrix (Original)",
  xlab = "Time",
  ylab = "Thousands of Vehicles",
  col = 1:12
)
...
ts.plot(
  matrix(d12serie, nr = 12),
  main = "Time Series Matrix (Differenced)",
  xlab = "Time",
  ylab = "Values (D12)",
  col = 1:12
)
