...
last_diff <- tail(d1_d12_ln_serie, 1)
...
tl <- ts(tl, start = ultim, freq = 12)
tu <- ts(tu, start = ultim, freq = 12)
pr <- ts(pr, start = ultim, freq = 12)

# Plot the prediction
ts.plot(serie_extended, tl, tu, pr, lty = c(1, 2, 2, 1), col = c(1, 4, 4, 2), xlim = c(serie_end[1] - 2, serie_end[1] + 2), type = "o", main = paste("Model ARIMA(", paste(c(2, 0, 4), collapse = ","), ")", sep = ""))
